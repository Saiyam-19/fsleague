              ...
              <div className="card-body p-lg-5">
                ...
                <form action="index.html">
                  ...
                  <div className="form-group">
                    <button className="btn btn-primary" id="regidter" type="button" name="registerSubmit" onClick={() => {navigate("/login" + location.search); }}>Register</button>
                  </div>
                </form>
              </div>
              <div className="card-footer px-lg-5 py-lg-4">
                <div className="text-sm text-muted">Already have an account? <a onClick={() => {navigate("/login" + location.search); }}>Login</a>.</div>
              </div>
            </div>
          </div>
